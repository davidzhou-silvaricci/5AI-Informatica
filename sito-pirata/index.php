  ...
  <body>
    <div class="container px-8 mx-auto py-16 min-h-screen">
      ...
      <div class="grid grid-cols-5 gap-4">
        <div>
          <a href="<?= Url::toForm() ?>" class="block flex justify-center items-center border px-8 py-4 bg-white font-medium transition-colors hover:bg-gray-100 rounded-lg">Aggiungi</a>
          ...
          <div class="flex flex-col gap-2">
            <a href="<?= Url::viewClienti(0) ?>">Informatico</a>
            <a href="<?= Url::viewClienti(1) ?>">Studente</a>
            <a href="<?= Url::viewClienti(2) ?>">Altro</a>
          </div>
        </div>
